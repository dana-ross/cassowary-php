...
//class ClStrengthTest {
//	public static void test_main() {
//		$clsw = new ClSymbolicWeight(0.0, 1.0, 0.0);
//		$clsw2 = new ClSymbolicWeight(2.0, 0.5, 0.5);
//		$clsw3 = new ClSymbolicWeight(2.0, 0.5, 0.5);
//		$clsw4 = new ClSymbolicWeight(2.0, 0.4, 0.5);
//
